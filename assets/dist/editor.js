var Editor = function() {
    ...
    function A() {
        return {
            ...
            newTitleText: "Tambahkan Kegiatan",
            editTitleText: "Edit Kegiatan",
            start_date: "",
            start_time: "",
            end_date: "",
            end_time: "",
            color: "",
            colorOptions: ["#00008b", "#FF0000"]
        }
    }
    ...
    function I() {
        ...
        this.set({
            ...
            var o = n.entry;
            confirm("Yakin mau dihapus?") && (t.delete(o), e.set({
                showModal: !1
            }))
    ...
    function B(t, e) {
        ...
        return gt.on("modalClose", function(t) {
            ...
            c: function() {
                m = l("div"), (v = l("label")).textContent = "Nama Kegiatan", p = c("\n    "), g = l("input"), y = c("\n  "), b = l("div"), (w = l("label")), x = c("\n    "), k = l(), C = c("\n  "), N = l("div"), T = l("div"), (S = l("label")).textContent = "Mulai", E = c("\n      "), D = l("input"), M = c("\n    "), ht && ht.c(), A = c("\n  "), I = l("p"), B = c(ct), q = c("\n  "), H = l("div"), z = l("div"), (P = l("label")).textContent = "Selesai", R = c("\n      "), U = l("input"), $ = c("\n    "), _t && _t.c(), G = c("\n  "), J = l("p"), K = c(ut), Q = c("\n\n  "), V = l("div"), (W = l("label")).textContent = "Pilih Aula", X = c("\n    "), Z = l("div");
                for (var t = 0; t < vt.length; t += 1) vt[t].c();
                tt = c("\n  "), et = l("div"), (nt = l("label")).textContent = "Upload File", ot = c("\n    "), (it = l("button")).textContent = "Pilih File Pdf", rt = c("\n  "), (st = l("button")).textContent = "Kirim", gt._fragment.c(), this.h()
            },
            h: function() {
                Y(m), m.className = "field", Y(v), Y(g), g.id = "entry-title", g.type = "text", g.placeholder = "Masukkan Nama Kegiatan", d(g, "input", o),Y(N), N.className = "field-group", Y(T), T.className = "field", Y(S), Y(D), D.type = "text", D.placeholder = "YYYY-MM-DD", d(D, "input", r), Y(I), I.className = "feedback", Y(H), H.className = "field-group", Y(z), z.className = "field", Y(P), Y(U), U.type = "text", U.placeholder = "YYYY-MM-DD", d(U, "input", f), Y(J), J.className = "feedback", Y(V), V.className = "field", Y(W), Y(Z), Y(et), et.className = "field", Y(nt), Y(it), it.className = "button", d(it, "click", _), Y(st), st.className = "button", d(st, "click", _)
            },
            m: function(o, i) {
