...
<!-- modal untuk informasi -->
                    ...
                    <div class="features">
                        <article>
                            ...
                            <div class="content">
                                <img src="<?php echo base_url('assets/img/reportkegiatan.png')?>" class="img-fluid" alt="Responsive image" width="100%">
                            </div>
                        </article>
                        <article>
                            <div class="content">
                                <p class="customtext">Silahkan melakukan laporan kegiatan maksimal h+7 dari waktu terlaksanakannya acara, agar dapat mengajukan kembali pencairan dana
                                    <br>Dana Sisa Pagu Anggaran Anda </br>
                                    Rp. 13.000.000
                                    <form>
                                        <div class="form-group">
                                            <h3>Lampirkan Laporan Kegiatan</h3>
                                            <label for="exampleFormControlFile1"></label>
                                            <input type="file" class="form-control-file" id="exampleFormControlFile1">
                                        </div>
										<br>
										<a href="<?php echo base_url().'c_user/Verifikasi_Laporan';?>">
										<p><button type="button" class="btn btn-primary" ">Kirim</button></p></a>
                                    </form>
                            </div>
                        </article>
                        </div>
