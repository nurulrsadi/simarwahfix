  ...
  <section>
                        ...
                        <div class="features">
                         ...
                         <article>
                            <div class="content">
                                <img src="<?php echo base_url('assets/img/profile.png')?>" class="img-fluid" alt="Responsive image" width="100%">
                            </div>
                        </article>
                    </div>
                    ...
                    foreach($bidangbidang->result_array() as $i):
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><center>
                                <a class="btn btn-warning" data-toggle="modal" data-target="#modal_update_bidang<?php echo $kode;?>">Edit</a>
                                <a class="btn btn-danger" data-toggle="modal" data-target="#modal_delete_bidang<?php echo $kode;?>">Delete</a>
                            </center>
                        </td>
                    </tr>
                </tbody>
                    ...
                    foreach($bidang_ukmukk->result_array() as $i):
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><center>
                                <a class="btn btn-warning" data-toggle="modal" data-target="#modal_update_bidang_ukmukk<?php echo $kode_ubidang;?>">Edit</a>
                                <a class="btn btn-danger" data-toggle="modal" data-target="#modal_delete_bidang_ukmukk<?php echo $kode_ubidang;?>">Delete</a>
                            </center>
                        </td>
                    </tr>
                </tbody>
                      ...
                      foreach($anggota->result_array() as $i):
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><center>
                                <a class="btn btn-warning" data-toggle="modal" data-target="#modal_edit_new<?php echo $nim;?>">Edit</a>
                      ...
                      foreach($anggota_ukmukk->result_array() as $i):
                        ...
                        <tbody>
                            <tr>
                              ...
                              <td><?php echo $ukmbidang ?></td>
                              <td><center>
                                <a class="btn btn-warning" data-toggle="modal" data-target="#modal_edit_anggota_ukmukk<?php echo $u_nim;?>">Edit</a>
                                <a class="btn btn-danger" data-toggle="modal" data-target="#modal_delete_anggota_ukmukk<?php echo $u_nim;?>">Delete</a>
                            </center>
                        </td>
                    </tr>
                </tbody>
    ...
    <div class="modal fade" id="modal_delete_anggota_ukmukk<?php echo $u_nim;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <h4>Nama : <?php echo $u_nama;?></h4>
                        <h4>Bidang : <?php echo $bidangcurrent;?></h4>
                        <h4>Jabatan : <?php echo $u_jabatan;?></h4>
                        <center>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url().'c_user/simpan_visi_misi'?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input value="<?php echo $visi;?>" name="visi" class="form-control" type="text" placeholder="Visi Himpunan" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input value="<?php echo $misi;?>" name="misi" class="form-control" type="text" placeholder="Misi Himpunan" required>
                            </div>
                        </div>
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url().'c_user/simpan_visimisi_ukmukk'?>">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Visi</label>
                            <div class="col-xs-8">
                                <input value="<?php echo $visi_ukmukk;?>" name="visi_ukmukk" class="form-control" type="text" placeholder="Visi UKM/UKK" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Misi</label>
                            <div class="col-xs-8">
                                <input value="<?php echo $misi_ukmukk;?>" name="misi_ukmukk" class="form-control" type="text" placeholder="Misi UKM/UKK" required>
                            </div>
                        </div>
                ...
                <form class="form-horizontal" action="<?php echo base_url().'c_user/tambah_bidang';?>" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-8">
                                <input value="" name="label_bidang" class="form-control" type="text" placeholder="Label Bidang" required>
                            </div>
                        </div>
                ...
                <form class="form-horizontal" action="<?php echo base_url().'c_user/tambah_bidang_ukmukk';?>" enctype="multipart/form-data" method="post">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Kode Bidang</label>
                            <div class="col-xs-8">
                                <input value="" name="kode_ubidang" class="form-control" type="text" autocomplete="off" placeholder="Kode Bidang" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Label Bidang</label>
                            <div class="col-xs-8">
                                <input value="" name="label_ubidang" class="form-control" type="text" autocomplete="off" placeholder="Label Bidang" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-3" >Nama Bidang</label>
                            <div class="col-xs-8">
                                <input value="" name="desc_ubidang" class="form-control" autocomplete="off" type="text" placeholder="Nama Bidang" required>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal_delete_bidang<?php echo $kode_bidang;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <center><h4>Nama Bidang : <?php echo $label_bidang;?> - <?php echo $nama_bidang;?></h4></center>
                        <center>
                         <a class="btn btn-danger" href="<?php echo base_url('c_user/delete_data_bidang/'.$kode_bidang); ?>">Lanjutkan</a>
                        </center>
                    </div>
                </div>
                </div>
    ...
    <div class="modal fade" id="modal_delete_bidang_ukmukk<?php echo $kode_ubidang;?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <center> <img width="80" height="80" style="border-radius: 50px" src="<?php echo base_url('assets/img/bidang/').$logo?>"></center>
                        <center><h4>Nama Bidang : <?php echo $label_ubidang;?> - <?php echo $desc_ubidang;?></h4></center>
                        <center>
