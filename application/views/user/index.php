...
<section>
  ...
  <div class="features">
    ...
    <article>
      <div class="content">
       <h2>HI, Admin <?php echo strtoupper($this->session->userdata('nama')) ?> !</h2>
          ...
          <div class="modal-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url().'c_user/tambah_bidang';?>" enctype="multipart/form-data" method="post">
              ...
              <div class="form-group">
                ...
                <div class="col-xs-8">
                  <input onkeypress="return disablespace()" style="text-transform:uppercase;" value="" name="kode_bidang" class="form-control" type="text" placeholder="ex: " required>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="control-label col-xs-3" >Deskripsi Bidang</label>
                <div class="col-xs-8">
    ...
    <div class="modal-content">
      ...
      <form class="form-horizontal" action="<?php echo base_url().'c_user/tambah_bidang_ukmukk';?>" enctype="multipart/form-data" method="post">
        ...
        <div class="form-group">
          <label class="control-label col-xs-3" >Kode Bidang</label>
          <div class="col-xs-8">
            <input onkeypress="return disablespace()" value="" name="kode_ubidang" class="form-control" type="text" style="text-transform:uppercase;" autocomplete="off" placeholder="Kode Bidang" required>
          </div>
        </div>
