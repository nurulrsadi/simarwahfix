						...
						<div class="container">
							...
							<div class="collapse navbar-collapse" id="myNavbar">
								<ul class="nav navbar-nav navbar-right">
									...
									<li class=""><a href="#testimonial">Daftar Kegiatan</a></li>
									<li class=""><a href="#aulasc">Peminjaman Aula SC</a></li>
						...
						<div class="kotakb" style="margin-left: 20;">
							<div class="service-item">
								<a href="<?php echo base_url().'c_home/himpunan/'.$kode_himpunan.'';?>">
									<img src="<?php echo base_url('assets/img/jurusan/').$image;?>"
		...
		<section id="ukm" class="section-padding wow fadeInUp delay-05s">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
						<figure>
							<a href="<?php echo base_url().'c_home/ukmaja';?>">
								<img src="<?php echo base_url('assets/img/pramuka.jpg')?>" style="width: 500px; height: 250px;"
					...
					<div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
						<figure>
							<img src="<?php echo base_url('assets/img/PSM.jpg')?>" style="width: 500px; height: 250px;"
								class="img-responsive">
							<figcaption>
								<h2>PSM</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
						<figure>
							<img src="<?php echo base_url('assets/img/fabbis.jpg')?>" style="width: 500px; height: 250px;"
								class="img-responsive">
							<figcaption>
								<h2>FABBIS</h2>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
						<figure>
							<img src="<?php echo base_url('assets/img/liga.jpg')?>" style="width: 500px; height: 250px;"
								class="img-responsive">
							<figcaption>
								<h2>LIMA</h2>
								<p>Liga Mahasiswa</p>
					...
					<div class="col-md-4 col-sm-6 col-xs-12 portfolio-item padding-right-zero mr-btn-15">
						<figure>
							<img src="<?php echo base_url('assets/img/LDM.jpg')?>" style="width: 500px; height: 250px;"
								class="img-responsive">
							<figcaption>
								<h2>LDM</h2>
					...
					<div class="col-md-12 col-sm-12 col-xs-12 text-center">
						...
						<h4><a href="<?php echo base_url().'c_home/semuaukm';?>" style="color: #85C441" class="read-more">Lihat
								Lebih →</a></h4>
					</div>
				</div>
			</div>
