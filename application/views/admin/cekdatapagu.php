	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext" id="staticEmail" value="PORSENIF, DIESNAL, MUSKOM">
				</div>
			</div>
			<!-- <div class="form-group row">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" readonly class="form-control-plaintext" id="staticEmail" value="PengajuanDanaHimatif1.pdf">
				</div>
			</div>
			<div class="form-group row">
